...
PATH = 'C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\bLS data';
foldout = 'C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\Figures';
...
if LOAD_SWITCH == 1
    ...
    CRDS_field = [];
    datafiles=recursivedir('C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\CRDS\CRDS field','*.dat');
    ...
    %========================================================================%
    CRDS_bg = [];
    datafiles=recursivedir('C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\CRDS\CRDS bg','*.dat');
    ...
    CRDS_G4301 = [];
    datafiles=recursivedir('C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\CRDS\Backpack','*.dat');
    ...
    save('WTbLS_CRDS_field_2nd.mat', 'CRDS_field');
    save('WTbLS_CRDS_bg_2nd.mat', 'CRDS_bg');
    ...
    newTimes = [datetime('2021-08-20 08:00:00'):minutes(30):datetime('2021-08-30 10:00:00')];
    ...
    save('WTbLS_TT_CRDS_2nd.mat', 'TT_CRDS');
    ...
    newTimes = [datetime('2021-08-09 13:00:00'):minutes(30):datetime('2021-08-30 10:00:00')];
    TT_rain = retime(TT_rain, newTimes, 'sum');

    TT_rain.sum_mm = cumsum(TT_rain.mm);
    TT_rain(:,1:2) = [];

    save('WTbLS_TT_rain_2nd.mat', 'TT_rain')
    ...
    save('WTbLS_Vejr_2nd.mat', 'TT_Vejr')
    writetimetable(TT_Vejr, [PATH, '\eGylle_2_Vejr.txt'], 'Delimiter','tab')
    ...
    load('WTbLS_CRDS_field_2nd.mat')
    load('WTbLS_CRDS_bg_2nd.mat')
...
if LOAD_SWITCH == 1
    ...
    % Import the data
    WTbLS_1 = readtable("C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\bLS data\bLS_WT_CRDS.csv", opts);
    ...
    %% Missing data added
    load('C:\Users\AU323818\Dropbox\Uni\eGylle\2nd trial Aug21\bLS data\eGylle_2_TT_EC.mat') % TT_EC
    TT_EC(485,:) = [];
    ix_nan = isnan(TT_bLS.L);

    TT_bLS.Ustar(ix_nan) = TT_EC.UST(ix_nan);
    TT_bLS.L(ix_nan) = TT_EC.L(ix_nan);
    TT_bLS.WD(ix_nan) = TT_EC.WD(ix_nan);
    TT_bLS.WS(ix_nan) = TT_EC.WS(ix_nan);
    TT_bLS.airT(ix_nan) = TT_EC.airT(ix_nan);
    TT_bLS.Pair(ix_nan) = TT_EC.Pair(ix_nan);
    ...
    save('WTbLS_TT_bLS_2nd.mat', 'TT_bLS')
...
% TAN_alpha_2 = cumsum((DE_alpha_2.Emis .* seconds(DE_alpha_2.et-DE_alpha_2.st)) / (TAN_slurry)*100, 'omitnan');

% TAN_alpha_1 = [0; TAN_alpha_1];
% TAN_alpha_2 = [0; TAN_alpha_2];
% TAN_BUH_gap = [0; TAN_BUH_gap];
...
if PLOT_SWITCH == 1
    TimeLim = [datetime('2021-08-20 08:00:00'), datetime('2021-08-30 10:00:00')];
    ii = 50;
    ...
    subplot(4,1,4)
    plot(TT_bLS.Time, 1./TT_bLS.L)
    ylabel({'1 / L', '(m^{-1})'},'FontSize',SizeOfFont, 'color','k')
    legend({'1/L'}, 'FontSize',SizeOfFontLgd)
    grid minor
    xlim(TimeLim)
    xlabel('Time')
